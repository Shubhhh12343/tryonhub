...
var FullCalendar = (function (exports) {
    ...
    function renderInnerContent$4(innerProps) {
        return (createElement("div", { className: "fc-event-main-frame " },
            ...
            createElement("div", { className: "fc-event-title-container" },
                createElement("div", { className: "fc-event-title fc-sticky" }, innerProps.event._def.extendedProps.project_name + ' | ' + innerProps.event.title || createElement(Fragment, null, "\u00A0")))));
    }
    ...
    var Popover = /** @class */ (function (_super) {
        ...
        function Popover() {
            ...
            // Triggered when the user clicks *anywhere* in the document, for the autoHide feature
              ...
              _this.handleDocumentMouseDown = function (ev) {
                // Exclude clicks within the popover, modal body, and modal close button
                if (!_this.rootEl.contains(ev.target) && !_this.isClickWithinModalBody(ev.target) && !_this.isClickWithinModalCloseButton(ev.target)) {
                    _this.handleCloseClick();
                }
            };
            
            // Method to check if the click is within the modal body
            _this.isClickWithinModalBody = function (target) {
                // Modify this condition based on your modal structure
                return target.closest('.modal-body') !== null;
            };
            
            // Method to check if the click is on the modal close button
            _this.isClickWithinModalCloseButton = function (target) {
                // Modify this condition based on your modal close button structure
                return target.closest('[data-bs-dismiss="modal"]') !== null;
            };

        // end trigger hidding popove
        ...
        Popover.prototype.render = function () {
            ...
            return createPortal(createElement("div", __assign({ id: props.id, className: classNames.join(' '), "aria-labelledby": state.titleId }, props.extraAttrs, { ref: this.handleRootEl }),
                createElement("div", { className: 'fc-popover-header sticky-top top-0 ' + theme.getClass('popoverHeader') },
    ...
    */
    ...
    function renderInnerContent$2(innerProps) {
        return (createElement(Fragment, null,
            createElement("div", { className: "fc-daygrid-event-dot", style: { borderColor: "pink" || "pink", backgroundColor: "black" } }),
            //innerProps.timeText && (createElement("div", { className: "fc-event-time" }, innerProps.timeText)),
            createElement("div", { className: "fc-event-title text-outline-primary text-truncate mw-75 " }, innerProps.event._def.extendedProps.project_name + ' | ' + innerProps.event.title || createElement(Fragment, null, "\u00A0"))));
    }
